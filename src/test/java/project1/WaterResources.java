...
public class WaterResources {
	...
	String AppURL="https://www.nrcs.usda.gov/wps/portal/nrcs/main/az/water/resources/";
	...
	public void title(){
     ...
     driver.get(AppURL);	
		 ...
		 String title =driver.getTitle();
	       ...
	       Assert.assertEquals(true, driver.getTitle().equalsIgnoreCase("Water Resources | NRCS Arizona"));
		 
		
       System.out.println("The browser title is : Water Resources | NRCS Arizona");
