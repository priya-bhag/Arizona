...
public class Forestry {
	...
	String AppURL="https://www.nrcs.usda.gov/wps/portal/nrcs/main/az/technical/landuse/forestry/";
	...
	public void title(){
     ...
     driver.get(AppURL);	
		 ...
		 String title =driver.getTitle();
	       ...
	       Assert.assertEquals(true, driver.getTitle().equalsIgnoreCase("Forestry | NRCS Arizona"));
		 
		
       System.out.println("The browser title is : Forestry | NRCS Arizona");
