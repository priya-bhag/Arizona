...
public class FinancialAssistance {
	...
	String image3=".//*[@id='overview']/div[2]/table/tbody/tr[2]/td[1]/a/img";
	String image4=".//*[@id='overview']/div[2]/table/tbody/tr[3]/td[1]/a/img";
	
	
	
	
		String AppURL="https://www.nrcs.usda.gov/wps/portal/nrcs/main/az/programs/financial/";
		...
		public void title(){
	     ...
	     driver.get(AppURL);	
			 ...
			 String title =driver.getTitle();
		       ...
		       Assert.assertEquals(true, driver.getTitle().equalsIgnoreCase("Financial Assistance | NRCS Arizona"));
			 
			
	       System.out.println("The browser title is : Financial Assistance | NRCS Arizona");
	       ...
	       String heading = driver.findElement(By.xpath(".//*[@id='overview']/h2/a")).getText();
			...
			Assert.assertEquals(true,heading.contentEquals("Financial Assistance"));
	...
	public void FinancialAssistance_links(){
			...
			System.out.println(" number of links FinancialAssistance are "+ ele_items.size()) ;
		
			System.out.println("");
			
			System.out.println("The links in the FinancialAssistance table are  : ");
		...
		public void FinancialAssistance_verify(){
			...
			System.out.println("Verifying links in the FinancialAssistance are  : ");
		...
		public void CTA(){
			FinancialAssistance_links();
			FinancialAssistance_verify();
			image(image1);
			driver.close();
		}
