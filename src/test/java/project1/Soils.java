...
public static WebDriver driver;
	...
	String AppURL="https://www.nrcs.usda.gov/wps/portal/nrcs/main/az/soils/";
	...
	public void title(){
     ...
     driver.get(AppURL);	
		 ...
		 String title =driver.getTitle();
	       ...
	       Assert.assertEquals(true, driver.getTitle().equalsIgnoreCase("Soils | NRCS Arizona"));
		 
		
       System.out.println("The browser title is : Soils | NRCS Arizona");
       ...
       String heading = driver.findElement(By.xpath(".//*[@id='overview']/h2/a")).getText();
		...
		Assert.assertEquals(true,heading.contentEquals("Soils"));
...
public void  Soils_links(){
		
		WebElement ele = driver.findElement(By.xpath(".//*[@id='overview']"));
		
		List<WebElement>ele_items = ele.findElements(By.tagName("a"));
		
		System.out.println(" number of links in soils are "+ ele_items.size()) ;
	
		System.out.println("");
		
		System.out.println("The links in the soils table are  : ");
	...
	public void Soils_verify(){
		...
		System.out.println("Verifying links in the soils are  : ");
