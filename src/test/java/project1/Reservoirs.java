...
public class Reservoirs {
	...
	String AppURL="https://www.nrcs.usda.gov/wps/portal/nrcs/main/az/snow/waterproducts/reservoirs/";
	...
	public void title(){
     ...
     driver.get(AppURL);	
		 ...
		 String title =driver.getTitle();
	       ...
	       Assert.assertEquals(true, driver.getTitle().equalsIgnoreCase("Reservoirs | NRCS Arizona"));
		 
		
       System.out.println("The browser title is :Reservoirs | NRCS Arizona");
