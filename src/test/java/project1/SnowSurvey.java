...
public class SnowSurvey {
	
	
public static WebDriver driver;
	
	String image1 =".//*[@id='overview']/table[1]/tbody/tr[1]/td[1]/img";
	String image2 =".//*[@id='table1']/tbody/tr/td[1]/img";
	String image3=".//*[@id='table1']/tbody/tr/td[2]/h5[1]/img";

	String AppURL="https://www.nrcs.usda.gov/wps/portal/nrcs/main/az/snow/#";
	...
	//getting elements on the left size
...
/*WebElement table=driver.findElement(By.xpath(".//*[@id='subnav']"));
		...
		for (int j=0; j<=links.size()-1; j=j+1)
			 
		{
		 ...
		 String title =driver.getTitle();
	       ...
	       Assert.assertEquals(true, driver.getTitle().equalsIgnoreCase("Snow Survey | NRCS Arizona"));
		 
		
       System.out.println("The browser title is : Snow Survey | NRCS Arizona");
       
		
       String heading = driver.findElement(By.xpath(".//*[@id='overview']/h2")).getText();
		
		//validating heading
		
		Assert.assertEquals(true,heading.contentEquals("Snow Survey"));
...
public void SnowSurvey_links(){
		...
		System.out.println(" number of links in SnowSurvey are "+ ele_items.size()) ;
	
		System.out.println("");
		
		System.out.println("The links in the SnowSurvey table are  : ");
	...
	public void SnowSurvey_verify(){
		...
		System.out.println("Verifying links in the SnowSurvey  are  : ");
