...
public static WebDriver driver;
	...
	String AppURL="https://www.nrcs.usda.gov/wps/portal/nrcs/main/az/people/partners/";
	...
	public void title(){
     ...
     driver.get(AppURL);	
		 ...
		 String title =driver.getTitle();
	       ...
	       Assert.assertEquals(true, driver.getTitle().equalsIgnoreCase("Partners | NRCS Arizona"));
		 
		
       System.out.println("The browser title is : Partners | NRCS Arizona");
       ...
       String heading = driver.findElement(By.xpath(".//*[@id='overview']/h2/a")).getText();
		...
		Assert.assertEquals(true,heading.contentEquals("Partners"));
