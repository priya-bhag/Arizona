...
public class Data_Maps_Analysis {
	public static WebDriver driver;

	String AppURL="https://www.nrcs.usda.gov/wps/portal/nrcs/main/az/technical/dma/";
	...
	public void title(){
     ...
     driver.get(AppURL);	
		 ...
		 String title =driver.getTitle();
	       ...
	       Assert.assertEquals(true, driver.getTitle().equalsIgnoreCase("Data, Maps, & Analysis | NRCS Arizona"));
		 
		
       System.out.println("The browser title is : Data, Maps, & Analysis | NRCS Arizona");
