...
public class Air {
	...
	String AppURL="https://www.nrcs.usda.gov/wps/portal/nrcs/main/az/air/";
	...
	public void title(){
	 ...
	 driver.get(AppURL);	
		 ...
		 String title =driver.getTitle();
	       ...
	       Assert.assertEquals(true, driver.getTitle().equalsIgnoreCase("Air | NRCS Arizona"));
		 
		
	   System.out.println("The browser title is :Air | NRCS Arizona");
	   ...
	   String heading = driver.findElement(By.xpath(".//*[@id='overview']/h2/a")).getText();
		...
		Assert.assertEquals(true,heading.contentEquals("Air"));
