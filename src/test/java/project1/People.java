...
public class People {
	...
	String AppURL="https://www.nrcs.usda.gov/wps/portal/nrcs/main/az/people/";
	...
	public void title(){
     ...
     driver.get(AppURL);	
		 ...
		 String title =driver.getTitle();
	       ...
	       Assert.assertEquals(true, driver.getTitle().equalsIgnoreCase("People | NRCS Arizona"));
		 
		
       System.out.println("The browser title is :People | NRCS Arizona");
