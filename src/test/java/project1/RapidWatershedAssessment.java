...
public class RapidWatershedAssessment {
	
	public static WebDriver driver;

	String AppURL="https://www.nrcs.usda.gov/wps/portal/nrcs/main/az/technical/dma/rwa/";
	...
	public void title(){
	 ...
	 driver.get(AppURL);	
		 ...
		 String title =driver.getTitle();
	       ...
	       Assert.assertEquals(true, driver.getTitle().equalsIgnoreCase("Rapid Watershed Assessment | NRCS Arizona"));
		 
		
	   System.out.println("The browser title is :Rapid Watershed Assessment | NRCS Arizona");
	   ...
	   String heading = driver.findElement(By.xpath(".//*[@id='overview']/h2/a")).getText();
		...
		Assert.assertEquals(true,heading.contentEquals("Rapid Watershed Assessment"));
	...
	public void Rapid(){
		...
		System.out.println(" number of links in Rapid are "+ ele_items.size()) ;

		System.out.println("");
		
		System.out.println("The links in the Rapid table are  : ");
	...
	public void Check_links_InRapid(){
		...
		System.out.println("Verifying links in the Rapid are  : ");
