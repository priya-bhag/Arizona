...
public class PestManagement {
	...
	String AppURL="https://www.nrcs.usda.gov/wps/portal/nrcs/main/az/technical/ecoscience/pest/";
	...
	public void title(){
     ...
     driver.get(AppURL);	
		 ...
		 String title =driver.getTitle();
	       ...
	       Assert.assertEquals(true, driver.getTitle().equalsIgnoreCase("Pest Management | NRCS Arizona"));
		 
		
       System.out.println("The browser title is :Pest Management | NRCS Arizona");
