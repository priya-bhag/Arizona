...
public static WebDriver driver;
	...
	String image1 =".//*[@id='overview']/h3[1]/img";
	

	String AppURL="https://www.nrcs.usda.gov/wps/portal/nrcs/main/az/people/volunteers/";
	...
	public void title(){
     ...
     driver.get(AppURL);	
		 ...
		 String title =driver.getTitle();
	       ...
	       Assert.assertEquals(true, driver.getTitle().equalsIgnoreCase("Volunteers | NRCS Arizona"));
		 
		
       System.out.println("The browser title is :Volunteers | NRCS Arizona");
       ...
       String heading = driver.findElement(By.xpath(".//*[@id='overview']/h2/a")).getText();
		...
		Assert.assertEquals(true,heading.contentEquals("Volunteers"));
