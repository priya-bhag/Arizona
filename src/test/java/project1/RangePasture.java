...
public class RangePasture {
public static WebDriver driver;
	
	String image1 =".//*[@id='overview']/ul/li[1]/img";
	

	String AppURL="https://www.nrcs.usda.gov/wps/portal/nrcs/main/az/technical/landuse/pasture/";
	...
	public void title(){
     ...
     driver.get(AppURL);	
		 ...
		 String title =driver.getTitle();
	       ...
	       Assert.assertEquals(true, driver.getTitle().equalsIgnoreCase("Range & Pasture | NRCS Arizona"));
		 
		
       System.out.println("The browser title is :Range & Pasture | NRCS Arizona");
       ...
       String heading = driver.findElement(By.xpath(".//*[@id='overview']/h2/a")).getText();
		...
		Assert.assertEquals(true,heading.contentEquals("Range & Pasture"));
...
public void RangePasture_links(){
		
		WebElement ele = driver.findElement(By.xpath(".//*[@id='overview']"));
		
		List<WebElement>ele_items = ele.findElements(By.tagName("a"));
		
		System.out.println(" number of links in  RangePasture are "+ ele_items.size()) ;
	
		System.out.println("");
		
		System.out.println("The links in the  RangePasture table are  : ");
	...
	public void landuse_verify(){
		...
		System.out.println("Verifying links in the  RangePasture  are  : ");
