...
public class Forecasts {
	...
	String AppURL="https://www.nrcs.usda.gov/wps/portal/nrcs/main/az/snow/waterproducts/forecasts/";
	...
	public void title(){
     ...
     driver.get(AppURL);	
		 ...
		 String title =driver.getTitle();
	       ...
	       Assert.assertEquals(true, driver.getTitle().equalsIgnoreCase("Forecasts | NRCS Arizona"));
		 
		
       System.out.println("The browser title is :Forecasts | NRCS Arizona");
