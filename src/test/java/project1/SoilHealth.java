...
public static WebDriver driver;
	...
	String image1 =".//*[@id='overview']/p[4]/a/img";
	String image2 =".//*[@id='overview']/p[11]/a/img";
	String image3=".//*[@id='overview']/p[14]/a/img";
	String image4=".//*[@id='overview']/p[16]/img[1]";
	String image5=".//*[@id='overview']/p[17]/img";

	String AppURL="https://www.nrcs.usda.gov/wps/portal/nrcs/main/az/soils/health/";
	...
	public void title(){
     ...
     driver.get(AppURL);	
		 ...
		 String title =driver.getTitle();
	       ...
	       Assert.assertEquals(true, driver.getTitle().equalsIgnoreCase("Soil Health | NRCS Arizona"));
		 
		
       System.out.println("The browser title is :  Soil Health | NRCS Arizona");

       
		
       String heading = driver.findElement(By.xpath(".//*[@id='overview']/h2[1]/a")).getText();
		
		//validating heading
		
		Assert.assertEquals(true,heading.contentEquals("Soil Health"));
...
public void SoilHealth_links(){
		
		WebElement ele = driver.findElement(By.xpath(".//*[@id='overview']"));
		
		List<WebElement>ele_items = ele.findElements(By.tagName("a"));
		
		System.out.println(" number of links in Soil Health are "+ ele_items.size()) ;
	
		System.out.println("");
		
		System.out.println("The links in the Soil Health table are  : ");
	...
	public void SoilHealth_verify(){
		...
		System.out.println("Verifying links in the Soil Health  are  : ");
