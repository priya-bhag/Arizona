...
public static WebDriver driver;
	...
	String image1 =".//*[@id='overview']/h3/img";
	

	String AppURL="https://www.nrcs.usda.gov/wps/portal/nrcs/main/az/energy/";
	...
	public void title(){
     ...
     driver.get(AppURL);	
		 ...
		 String title =driver.getTitle();
	       ...
	       Assert.assertEquals(true, driver.getTitle().equalsIgnoreCase("Energy | NRCS Arizona"));
		 
		
       System.out.println("The browser title is :  Energy | NRCS Arizona");
       ...
       String heading = driver.findElement(By.xpath(".//*[@id='overview']/h2/a")).getText();
		...
		Assert.assertEquals(true,heading.contentEquals("Energy"));
