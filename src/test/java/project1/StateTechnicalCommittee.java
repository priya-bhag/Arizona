...
public class StateTechnicalCommittee {
	public static WebDriver driver;

	String AppURL="https://www.nrcs.usda.gov/wps/portal/nrcs/main/az/technical/stc/";
	...
	public void title(){
     ...
     driver.get(AppURL);	
		 ...
		 String title =driver.getTitle();
	       ...
	       Assert.assertEquals(true, driver.getTitle().equalsIgnoreCase("State Technical Committee | NRCS Arizona"));
		 
		
       System.out.println("The browser title is : State Technical Committee | NRCS Arizona");
       ...
       String heading = driver.findElement(By.xpath(".//*[@id='overview']/h2/a")).getText();
		...
		Assert.assertEquals(true,heading.contentEquals("State Technical Committee"));
...
public void StateTech_links(){
		...
		System.out.println(" number of links StateTech are "+ ele_items.size()) ;
	
		System.out.println("");
		
		System.out.println("The links in the StateTech table are  : ");
	...
	public void Check_links_InStateTech(){
		...
		System.out.println("Verifying links in the StateTech are  : ");
