...
public class LandUse {
	...
	String image1 =".//*[@id='overview']/table/tbody/tr/td[1]/img";
	String image2 =".//*[@id='overview']/table/tbody/tr/td[2]/img";
	String image3=".//*[@id='overview']/table/tbody/tr/td[3]/img";

	String AppURL="https://www.nrcs.usda.gov/wps/portal/nrcs/main/az/technical/landuse/";
	...
	public void title(){
     ...
     driver.get(AppURL);	
		 ...
		 String title =driver.getTitle();
	       ...
	       Assert.assertEquals(true, driver.getTitle().equalsIgnoreCase("Land Use | NRCS Arizona"));
		 
		
       System.out.println("The browser title is :  Land Use | NRCS Arizona");
       ...
       String heading = driver.findElement(By.xpath(".//*[@id='overview']/h2/a")).getText();
		...
		Assert.assertEquals(true,heading.contentEquals("Land Use"));
