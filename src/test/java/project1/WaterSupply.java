...
public class WaterSupply {
	...
	String AppURL="https://www.nrcs.usda.gov/wps/portal/nrcs/main/az/snow/waterproducts/supply/";
	...
	public void title(){
	 ...
	 driver.get(AppURL);	
		 ...
		 String title =driver.getTitle();
	       ...
	       Assert.assertEquals(true, driver.getTitle().equalsIgnoreCase("Water Supply | NRCS Arizona"));
		 
		
	   System.out.println("The browser title is :Water Supply | NRCS Arizona");
	   ...
	   String heading = driver.findElement(By.xpath(".//*[@id='overview']/h2/a")).getText();
		...
		Assert.assertEquals(true,heading.contentEquals("Water Supply"));
	...
	public void Check_links_InWaterSupply(){
	...
	public void NationsRes() throws InterruptedException{
		WaterSupply_links();
		Check_links_InWaterSupply();
		Thread.sleep(30);
		driver.close();
	}
	}
