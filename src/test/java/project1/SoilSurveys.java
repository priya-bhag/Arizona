...
public class SoilSurveys {
public static WebDriver driver;
	

	
	String AppURL="https://www.nrcs.usda.gov/wps/portal/nrcs/main/az/soils/surveys/";
	...
	public void title(){
     ...
     driver.get(AppURL);	
		 ...
		 String title =driver.getTitle();
	       ...
	       Assert.assertEquals(true, driver.getTitle().equalsIgnoreCase("Soil Surveys | NRCS Arizona"));
		 
		
       System.out.println("The browser title is : Soil Surveys | NRCS Arizona");
       ...
       String heading = driver.findElement(By.xpath(".//*[@id='overview']/h2/a")).getText();
		...
		Assert.assertEquals(true,heading.contentEquals("Soil Surveys"));
...
public void  SoilSurveys_links(){
		...
		System.out.println(" number of links in soilSurvey are "+ ele_items.size()) ;
	
		System.out.println("");
		
		System.out.println("The links in the soilSurvey table are  : ");
	...
	public void SoilSurveys_verify(){
		...
		System.out.println("Verifying links in the soilSurvey are  : ");
