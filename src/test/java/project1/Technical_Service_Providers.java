...
public class Technical_Service_Providers {
	
	
	public static WebDriver driver;

	String AppURL="https://www.nrcs.usda.gov/wps/portal/nrcs/main/az/technical/cp/tsp/";
	...
	public void title(){
     ...
     driver.get(AppURL);	
		 ...
		 String title =driver.getTitle();
	       ...
	       Assert.assertEquals(true, driver.getTitle().equalsIgnoreCase("Technical Service Providers | NRCS Arizona"));
		 
		
       System.out.println("The browser title is : Technical Service Providers | NRCS Arizona");
       ...
       String heading = driver.findElement(By.xpath(".//*[@id='overview']/h2/a")).getText();
		...
		Assert.assertEquals(true,heading.contentEquals("Technical Service Providers"));
...
public void TechServProv_links(){
		...
		System.out.println(" number of links in Tech Ser Provider are "+ ele_items.size()) ;
	
		System.out.println("");
		
		System.out.println("The links in the Tech service provider table are  : ");
	...
	public void TechServProv(){
		...
		System.out.println("Verifying links in the  Tech service provider  are  : ");
