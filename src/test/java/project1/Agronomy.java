...
public class Agronomy {
	...
	String AppURL="https://www.nrcs.usda.gov/wps/portal/nrcs/main/az/technical/ecoscience/agronomy/";
	...
	public void title(){
     ...
     driver.get(AppURL);	
		 ...
		 String title =driver.getTitle();
	       ...
	       Assert.assertEquals(true, driver.getTitle().equalsIgnoreCase("Agronomy | NRCS Arizona"));
		 
		
       System.out.println("The browser title is : Agronomy | NRCS Arizona");
