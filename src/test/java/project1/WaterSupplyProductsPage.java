...
public class WaterSupplyProducts {
	public static WebDriver driver;

	String AppURL="https://www.nrcs.usda.gov/wps/portal/nrcs/main/az/snow/waterproducts/#";
	...
	public void title(){
	 ...
	 driver.get(AppURL);	
		 ...
		 String title =driver.getTitle();
	       ...
	       Assert.assertEquals(true, driver.getTitle().equalsIgnoreCase("Water Supply Products | NRCS Arizona"));
		 
		
	   System.out.println("The browser title is :Water Supply Products | NRCS Arizona");
	   ...
	   String heading = driver.findElement(By.xpath(".//*[@id='overview']/h2/a")).getText();
		...
		Assert.assertEquals(true,heading.contentEquals("Water Supply Products"));
	...
	public void WaterSupplyProducts_links(){
		...
		System.out.println(" number of links in ater Supply Products are "+ ele_items.size()) ;

		System.out.println("");
		
		System.out.println("The links in Water Supply Products table are  : ");
	...
	public void Check_links_InWaterSupplyProducts(){
		...
		System.out.println("Verifying links in the Engg are  : ");
	...
	public void NationsRes(){
		WaterSupplyProducts_links();
		Check_links_InWaterSupplyProducts();
		driver.close();
	}
	}
