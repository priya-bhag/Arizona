...
public class CulturalResources {
	...
	String AppURL="https://www.nrcs.usda.gov/wps/portal/nrcs/main/az/technical/ecoscience/cultural/";
	...
	public void title(){
     ...
     driver.get(AppURL);	
		 ...
		 String title =driver.getTitle();
	       ...
	       Assert.assertEquals(true, driver.getTitle().equalsIgnoreCase("Cultural Resources | NRCS Arizona"));
		 
		
       System.out.println("The browser title is :Cultural Resources | NRCS Arizona");
