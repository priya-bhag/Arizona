...
public class Water {
	...
	String AppURL="https://www.nrcs.usda.gov/wps/portal/nrcs/main/az/water/";
	...
	public void title(){
     ...
     driver.get(AppURL);	
		 ...
		 String title =driver.getTitle();
	       ...
	       Assert.assertEquals(true, driver.getTitle().equalsIgnoreCase("Water | NRCS Arizona"));
		 
		
       System.out.println("The browser title is :  Water | NRCS Arizona");
