...
public class ConservationCompliance {
	
public static WebDriver driver;
	
	
	
String image1=".//*[@id='overview']/h4[1]/img";
	String AppURL="https://www.nrcs.usda.gov/wps/portal/nrcs/main/az/programs/farmbill/cc/";
	...
	public void title(){
     ...
     driver.get(AppURL);	
		 ...
		 String title =driver.getTitle();
	       ...
	       Assert.assertEquals(true, driver.getTitle().equalsIgnoreCase("Conservation Compliance | NRCS Arizona"));
		 
		
       System.out.println("The browser title is : Conservation Compliance | NRCS Arizona");
       ...
       String heading = driver.findElement(By.xpath(".//*[@id='overview']/h2/a")).getText();
		...
		Assert.assertEquals(true,heading.contentEquals("Conservation Compliance"));
...
public void Conserv_compla_links(){
	...
	public void conserv_compla_verify(){
	...
	public void CTA(){
		Conserv_compla_links();
		conserv_compla_verify();
		image(image1);
		driver.close();
	}
