...
public class BasinOutlookReports {
	
	public static WebDriver driver;

	String AppURL="https://www.nrcs.usda.gov/wps/portal/nrcs/main/az/snow/waterproducts/basin/";
	...
	public void title(){
	 ...
	 driver.get(AppURL);	
		 ...
		 String title =driver.getTitle();
	       ...
	       Assert.assertEquals(true, driver.getTitle().equalsIgnoreCase("Basin Outlook Reports | NRCS Arizona"));
		 
		
	   System.out.println("The browser title is :Basin Outlook Reports | NRCS Arizona");
	   ...
	   String heading = driver.findElement(By.xpath(".//*[@id='overview']/h2/a")).getText();
		...
		Assert.assertEquals(true,heading.contentEquals("Basin Outlook Reports"));
	...
	public void BasinOutlookReports_links(){
		...
		System.out.println(" number of links in Engg are "+ ele_items.size()) ;

		System.out.println("");
		
		System.out.println("The links in the Engg table are  : ");
	...
	public void Check_links_InBasinOutlookReports(){
	...
	public void NationsRes(){
		BasinOutlookReports_links();
		Check_links_InBasinOutlookReports();
		driver.close();
