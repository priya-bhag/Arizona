...
public class Watersheds {
	...
	String AppURL="https://www.nrcs.usda.gov/wps/portal/nrcs/main/az/water/watersheds/";
	...
	public void title(){
     ...
     driver.get(AppURL);	
		 ...
		 String title =driver.getTitle();
	       ...
	       Assert.assertEquals(true, driver.getTitle().equalsIgnoreCase("Watersheds | NRCS Arizona"));
		 
		
       System.out.println("The browser title is : Watersheds | NRCS Arizona");
