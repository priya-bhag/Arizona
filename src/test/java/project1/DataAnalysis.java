...
public class DataAnalysis {
	...
	String AppURL="https://www.nrcs.usda.gov/wps/portal/nrcs/main/az/snow/products/data/";
	...
	public void title(){
	 ...
	 driver.get(AppURL);	
		 ...
		 String title =driver.getTitle();
	       ...
	       Assert.assertEquals(true, driver.getTitle().equalsIgnoreCase("Data & Analysis | NRCS Arizona"));
		 
		
	   System.out.println("The browser title is :Data & Analysis | NRCS Arizona");
	   ...
	   String heading = driver.findElement(By.xpath(".//*[@id='overview']/h2/a")).getText();
		...
		Assert.assertEquals(true,heading.contentEquals("Data & Analysis"));
	...
	public void Data_links(){
		...
		System.out.println(" number of links in Data are "+ ele_items.size()) ;

		System.out.println("");
		
		System.out.println("The links in the Data table are  : ");
	...
	public void Check_links_InData(){
		...
		System.out.println("Verifying links in the Data are  : ");
