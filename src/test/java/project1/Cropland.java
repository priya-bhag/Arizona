...
public class Cropland {
	...
	String AppURL="https://www.nrcs.usda.gov/wps/portal/nrcs/main/az/technical/landuse/cropland/";
	...
	public void title(){
     ...
     driver.get(AppURL);	
		 ...
		 String title =driver.getTitle();
	       ...
	       Assert.assertEquals(true, driver.getTitle().equalsIgnoreCase("Cropland | NRCS Arizona"));
		 
		
       System.out.println("The browser title is : Cropland | NRCS Arizona");
