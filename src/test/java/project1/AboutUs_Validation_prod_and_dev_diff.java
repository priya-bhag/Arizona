...
public class AboutUs_Validation_prod_and_dev_diff {


	public static WebDriver driver;

	String AppURL1="https://www.nrcs.usda.gov/wps/portal/nrcs/main/az/about/";
    String AppURL2="https://www.nrcs.usda.gov/wps/portal/nrcs/main/az/about/civilrights/";
					             	...
					             	if(arrayD!=null)
					    	       {
					                 for (int j = 0; j < arrayD.length;j++)
					                 {
					                   if( arrayC[K].equals(arrayD[j]))
					                    {
					                    foundSwitch1 = true;
					                   // System.out.println("elements in both array URL are same " + foundSwitch1);
					                     }
